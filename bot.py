...
from handlers.manager import (
    cmd_stats, cmd_addmanager, cmd_iammanager,
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "*Manager commands:*\n"
        "/iammanager — register yourself as manager _(group admins only)_\n"
...
async def post_init(application):
    await application.bot.set_my_commands([
        ...
        ("balance",     "Your tokens & stats"),
        ("leaderboard", "Team ranking"),
        ("iammanager",  "Register as manager (group admins only)"),
        ("help",        "All commands"),
    ])
...
def main():
    ...
    app.add_handler(CommandHandler("iammanager",  cmd_iammanager))
